...
export function createParseContext(rootSchemaName: string, rootInput: unknown): ParseContext {
  return { rootSchemaName, rootInput, path: [], issues: [] }
}

export function withPathSegment(context: ParseContext, segment: PropertyKey): ParseContext {
